...
class AcademicRecordControllerTest {
    ...
    void testAddCompletedCourse() throws Exception {
        ...
        mockMvc.perform(post("/api/records/completed-courses")
    ...
    @Test
    @DisplayName("GET /api/records/completed-courses?studentId=101 returns 200 OK")
    void testGetCompletedCourses() throws Exception {
        ...
        mockMvc.perform(get("/api/records/completed-courses").param("studentId", "101"))
    ...
    @Test
    @DisplayName("GET /api/records/degree-progress?studentId=101 returns 200 OK")
    void testGetDegreeProgress() throws Exception {
        ...
        mockMvc.perform(get("/api/records/degree-progress").param("studentId", "101"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.statusCode").value(200))
    ...
    @Test
    @DisplayName("GET /api/records?studentId=101 returns complete academic record")
    void testGetAcademicRecord() throws Exception {
        ...
        mockMvc.perform(get("/api/records").param("studentId", "101"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.statusCode").value(200))
